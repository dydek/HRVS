...
SimplyKeyboard::SimplyKeyboard(uint8_t button_pin_1, uint8_t button_pin_2, AppFlow *flow)
{
...
void SimplyKeyboard::button_1_click_register(__appflow_callback callback)
{
    this->button_1_click_callback = callback;
}

void SimplyKeyboard::button_1_long_click_register(__appflow_callback)
{
}
